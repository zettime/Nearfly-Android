 ...
 */
public class NearflyService extends MyConnectionsService {
...
/*    if (mCurrentAnimator != null && mCurrentAnimator.isRunning()) {
  ...
  /*private static String[] join(String[] a, String... b) {
    ...
    protected void logV(String msg) {
        super.logV(msg);
        appendToLogs(toColor(msg, 0xFFFFFF));
    }

    @Override
    protected void logD(String msg) {
        super.logD(msg);
        appendToLogs(toColor(msg, 0xEEEEEE));
    }

    @Override
    protected void logW(String msg) {
        super.logW(msg);
        appendToLogs(toColor(msg, 0xE57373));
    }
    ...
    protected void logE(String msg, Throwable e) {
        super.logE(msg, e);
        appendToLogs(toColor(msg, 0xF44336));
    }
