...
import de.pbma.nearfly.MQTTService;
import de.pbma.nearfly.MyMqttListener;
...
public class MainActivityMQTT extends AppCompatActivity {
    ...
    MyMqttListener myMqttListener = new MyMqttListener() {
        @Override
        public void onMqttMessage(final String id, final String text) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myMqttListener.onMQTTStatus(false);
        pressOnHold = false;
    }
