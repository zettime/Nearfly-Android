...
import de.pbma.nearbyconnections.MsgForwarder;
...
public abstract class ConnectionsActivityTest extends AppCompatActivity {
  ...
  private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
      new ConnectionLifecycleCallback() {
        ...
        public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
          ...
          ConnectionsActivityTest.this.onConnectionInitiated(endpoint, connectionInfo);
        }
          ...
          if (!result.getStatus().isSuccess()) {
            logW(
                String.format(
                    ...
                    ConnectionsActivityTest.toString(result.getStatus())));
  ...
  // private final PayloadCallback mPayloadCallback = new ReceiveFilePayloadCallback(this);
